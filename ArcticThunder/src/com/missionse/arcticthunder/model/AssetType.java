...
public enum AssetType {
	FRIEND (0, Color.argb(50, 30, 220, 60), R.drawable.friendly_icon, BitmapDescriptorFactory.fromResource(R.drawable.friendly_icon), "Friend"),
	ENEMY_VEHICLE (0, Color.argb(50, 220, 20, 20), R.drawable.enemy_icon, BitmapDescriptorFactory.fromResource(R.drawable.enemy_icon), "Enemy Vehicle"),
	...
	ENEMY_ROAMING_TROOP (0, Color.argb(50, 220, 20, 20), R.drawable.enemy_icon, BitmapDescriptorFactory.fromResource(R.drawable.enemy_icon), "Enemy Roaming Troop"),
	...
	WIFI (0, Color.argb(50, 20, 220, 220), R.drawable.wifi_icon, BitmapDescriptorFactory.fromResource(R.drawable.wifi_icon), "Wifi Hotspot"),
	POSSIBLE_THREAT (0, Color.argb(50, 255, 255, 0), R.drawable.ic_launcher, BitmapDescriptorFactory.fromResource(R.drawable.ic_launcher), "Possible Threat");
