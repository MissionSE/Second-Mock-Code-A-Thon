...
public class ClientIntentService extends IntentService {
	...
	public static final String ACTION_SEND_UPDATE = "com.missionse.arcticthunder.SEND_MODEL_STATUS";
	public static final String EXTRAS_DATA = "update_data";
	...
	protected void onHandleIntent(final Intent intent) {
		...
		if (intent.getAction().equals(ACTION_SEND_UPDATE)) {
